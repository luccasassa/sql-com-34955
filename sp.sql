...
DROP PROCEDURE IF EXISTS filtrar_productos_segun;
...
# CALL ordenar_productos_segun (5, 1);
...
# CALL crear_nuevo_producto ('ASD-ASD', 'Prducto ASD-ASD', 'Nuevo producto asd-asd store procedure', 'lorem*10', 4, 1, 9999, 'https://luccasassa.netlify.app/');
...
# CALL filtrar_productos_segun ('inalámbrico');
